...
sequenceDiagram
    ...
    Note right of browser:A POST request is sent to /new_note with the form data in its request body
    ...
    Note left of server: Finally, the server redirects to /notes so the user sees the updated list
